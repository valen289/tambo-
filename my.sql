...
-- Insumos de ejemplo
INSERT INTO insumos (nombre, unidad, capacidad_maxima, stock_actual, stock_minimo) VALUES
('Maíz en Grano', 'kg', 10000, 8500, 2000),
('Soja', 'kg', 5000, 4200, 1000),
('Silo de Maíz', 'kg', 40000, 25000, 5000),
('Alfalfa', 'fardos', 2000, 1200, 300),
('Arroz', 'kg', 4000, 2000, 500);
